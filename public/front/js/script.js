...
(function($) {
  ...
  THEMEMASCOT.isLTR = {
	...
	// Work Carousel
	if ($('.work-carousel-two').length) {
		$('.work-carousel-two').owlCarousel({
			rtl: THEMEMASCOT.isRTL.check(),
			loop: true,
			margin: 30,
			nav: false,
  ...
  if ($('.testimonial-content-two').length) {
		var swiper = new Swiper(".testimonial-content-two", {
		spaceBetween: 10,
		slidesPerView: 1,
		thumbs: {
			swiper: swiper2,
	    ...
	    var swiper2 = new Swiper(".testimonial-image", {
			spaceBetween: 10,
			navigation: {
			  nextEl: ".swiper-button-next",
			  prevEl: ".swiper-button-prev",

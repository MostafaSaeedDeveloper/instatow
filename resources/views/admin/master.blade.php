          ...
          <div class="content">
            ...
            <div id="main-navigation" class="d-none d-lg-block push">
              <ul class="nav-main nav-main-horizontal nav-main-hover nav-main-dark">
                ...
                <li class="nav-main-item">
                  <a class="nav-main-link {{request()->is('dashboard/vehicles*') ? 'active' : ''}}" href="{{route('vehicles.index')}}">
...
<script src="{{asset('admin/assets/js/instatow.js')}}"></script>
        ...
        @include('admin.partials.recommend_price_modal')
...
<script>
    ...
    $('.js-select2').select2();
        ...
        $(document).on('click', '.delete-btn', function (event) {
            ...
            let form = $(this).closest('td').find('.delete_form');
    ...
    $(document).on('click', '.check-price', function(e) {
    e.preventDefault();

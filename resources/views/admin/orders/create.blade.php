                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input class="form-control" type="text" name="from_working_hours_days">
                                                <label class="form-label" for="example-select-floating">Days</label>
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input class="form-control" type="text" name="from_working_hours_time">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating mb-4">
                                                ...
                                                <input class="form-control" type="text" name="from_address2">
                                                <label class="form-label" for="example-select-floating">Address</label>
                                              </div>
                                        </div>
                                          <div class="col-md-12">
                                  ...
                                  <div class="col-md-6 d-flex align-items-center">
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="from_contact_name">
                                                  <label class="form-label" for="example-select-floating">Contact Name</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="from_contact_phone">
                                                  <label class="form-label" for="example-select-floating">Phone 1</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="from_contact_phone1">
                                                  <label class="form-label" for="example-select-floating">Phone 2</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="from_contact_company">
                                                  <label class="form-label" for="example-select-floating">Company Name</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="from_contact_buyer_number">
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input class="form-control" type="text" name="to_working_hours_days">
                                                <label class="form-label" for="example-select-floating">Days</label>
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input class="form-control" type="text" name="to_working_hours_time">
                                                <label class="form-label" for="example-select-floating">Time</label>
                                              </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating mb-4">
                                                <input class="form-control" type="text" name="to_address">
                                                <input class="form-control" type="text" name="to_address2">
                                                <label class="form-label" for="example-select-floating">Address</label>
                                              </div>
                                        </div>
                                          <div class="col-md-12">
                                  ...
                                  <div class="col-md-6 d-flex align-items-center">
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="to_contact_name">
                                                  <label class="form-label" for="example-select-floating">Contact Name</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="to_contact_phone">
                                                  <label class="form-label" for="example-select-floating">Phone 1</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="to_contact_phone1">
                                                  <label class="form-label" for="example-select-floating">Phone 2</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="to_contact_company">
                                                  <label class="form-label" for="example-select-floating">Company Name</label>
                                                </div>
                                          </div>
                                          <div class="col-md-12">
                                              <div class="form-floating mb-4">
                                                  <input class="form-control" type="text" name="to_contact_buyer_number">
                                                  <label class="form-label" for="example-select-floating">Buyer Number</label>
                                                </div>
                                          </div>
                                      </div>
                        ...
                        <div class="block-content">
                            <div class="row">
                                <div class="col-md-6 row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-4">
                                              <input class="form-control" type="date" name="load_date" placeholder="d/m/y">
                                              <label class="form-label" for="example-select-floating">Load Date</label>
                                          </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-4">
                                        <select class="js-select2 form-select" disabled id="stuff_calc" name="stuff_calc" style="width: 100%;" data-placeholder="Choose one..">
                                            ...
                                            <option value="Not more">Not more</option>
                                          </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating mb-4">
                                          <input class="form-control" id="stuff_description" disabled type="text" name="stuff_description">
                                ...
                                <div class="col-md-6 row">
                                    <div class="col-md-12">
                                        <div class="form-floating mb-4">
                                           <textarea class="form-control" name="notes_from_customer" style="height: 100px"></textarea>
                                            <label class="form-label" for="example-select-floating">Notes From Customer</label>
                                          </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating mb-4">
                                           <textarea class="form-control" name="notes_to_customer" style="height: 100px"></textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-4">
                                           <textarea class="form-control" name="notes_for_carrier" style="height: 100px"></textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <span class="total_deposit lh-34">
                                        ...
                                        <input type="hidden" value="0" name="total_deposit">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control carrier_pay" name="carrier_pay" value="0">
                                    </div>
                                </div>

...
<form id="wizard-form" action="{{route('place_order')}}" method="POST">
    ...
    <div class="step" id="step-1">
        ...
        <div class="col-md-4 col-sm-4 form-group">
            <select name="vehicles[0][make]"  class="select2 w-100 make" placeholder="" disabled required>
                <option value="">Select year first</option>
            </select>
          </div>
        <div class="col-md-4 col-sm-4 form-group">
            <select  name="vehicles[0][model]" class="select2 w-100 model" disabled required>

...
<form id="wizard-form" action="{{route('place_order')}}" method="POST">
    ...
    <div class="step" id="step-1">
        ...
        <div class="block-content" id="vehicleContainer">
            ...
            <div class="col-md-4 col-sm-4 form-group">
                <select   name="vehicles[0][year]" class="select2 w-100 year">
            ...
            <div class="col-md-4 col-sm-4 form-group">
                <input type="text" class="form-control"  name="vehicles[0][make]" required>
              </div>
            <div class="col-md-4 col-sm-4 form-group">
                <input type="text" class="form-control"  name="vehicles[0][model]" required>
              </div>
            </div>
            </div>
            </div>
        ...
        <div class="action-buttons">
            <button type="button" class="btn btn-success btn-sm" id="addVehicle">+
                + Add another vehicle
            </button>
    ...
    <div class="step" id="step-2" style="display: none;">
        ...
        <input type="hidden" name="type" value="ATV/UTV">

...
<div class="content-box">
    <div class="row">
        <div class="col-md-6">
            ...
            <h2 class="title words-slide-up text-split">Select Category</h2>
        </div>
  ...
  <div class="container">
    <div class="row category-container">
        <div class="col-md-3 col-sm-6 category-item">
            <a href="{{route('place_order_car')}}">
                <i class="fas fa-car"></i>
                <p>Car</p>
            </a>
        </div>
        <div class="col-md-3 col-sm-6 category-item">
            <a href="{{route('place_order_motorcycle')}}">
                <i class="fas fa-motorcycle"></i>
                <p>Motorcycle</p>
            </a>
        </div>
        <div class="col-md-3 col-sm-6 category-item">
            <a href="{{route('place_order_rv')}}">
                <i class="fas fa-caravan"></i>
                <p>RV/Trailer</p>
            </a>
        </div>
        <div class="col-md-3 col-sm-6 category-item">
            <a href="{{route('place_order_boat')}}">
